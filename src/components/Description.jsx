...
const Description = ({ setPlanner, planner, start, showDirection, fetchPlanner,filteredPlaces }) => {
  return (
    <div className="flex flex-col gap-y-5 pt-3 w-full h-screen justify-items-center overflow-auto">
      {start ? (
        ...
        <>
          <PlaceList setPlanner={setPlanner} planner={planner}filteredPlaces={filteredPlaces} />
          <button
